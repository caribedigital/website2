...
<body data-spy="scroll" data-offset="64" data-target="#section-topbar">
  ...
  <div id="headerwrap">
    <div class="container">
      <div class="row centered">
        <div class="col-lg-12">
          <h1>Gabriel Rivas Mier y Ter&aacute;n</h1>
          <h3>Web Developer | contact@gabrielrivas.com</h3>
        </div>
        <!--/.col-lg-12 -->
      </div>
      <!--/.row -->
  ...
  <div id="copyrights">
    <div class="container">
      <p>
        &copy; Copyrights <strong>Gabriel Rivas </strong>. All Rights Reserved
      </p>
      <div class="credits">
        <!--
        ...
        -->
        Created with &heartsuit; Kelvin template by <a href="https://templatemag.com/">TemplateMag</a>
      </div>
    </div>
  </div>
